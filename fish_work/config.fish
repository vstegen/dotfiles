...
fish_add_path $HOME/.local/bin $HOME/bin /apollo/env/envImprovement/bin $HOME/.bun/bin $HOME/.toolbox/bin /usr/local/go/bin $HOME/.local/bin $GOPATH/bin $HOME/.rbenv/bin $HOME/.fzf/bin $HOME/.cargo/bin $HOME/.emacs.d/bin
