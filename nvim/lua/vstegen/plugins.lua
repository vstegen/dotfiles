...
require("lazy").setup({
    ...
    },
    {
        ...
        keys = {
            {
                "<leader>fs", -- try it if you didn't it is a banger keybinding for a picker
                function()
        ...
        config = function()
            require("conform").setup {
                ...
                formatters_by_ft = {
                    ...
                    json = { "biomejs", "prettierd", "prettier", stop_after_first = true },
                    jsonc = { "biomejs", "prettierd", "prettier", stop_after_first = true },
                    yaml = { "biomejs", "prettierd", "prettier", stop_after_first = true },
